            ...
            children: [
              Align(
                  ...
                  child: IconButton(
                      ...
                      icon: const Icon(Icons.more_vert_outlined))),
              Align(
                  alignment: Alignment.topLeft, child: Text('FILLED - $label')),
            ],
          )),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Stack(
        children: [
          Image.network(
            'https://picsum.photos/id/${elevation.toInt()}/600/350?image=9',
            height: 350,
            fit: BoxFit.cover,
          ),
          Align(
              alignment: Alignment.topRight,
              child: Container(
                decoration: BoxDecoration( color :colors.secondary, borderRadius: BorderRadius.only(bottomLeft: Radius.circular(20))),
                child: IconButton(
                    onPressed: () {},
                    icon: const Icon(Icons.more_vert_outlined)),
              )),
